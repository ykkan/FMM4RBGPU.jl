...
struct InteractionListsGPU{I}
    ...
    p2p_lists_ptrs::Vecotr{I}
    m2l_lists_ptrs::Vecotr{I}
end
...
function InteractionListsGPU(clusters::Clusters{I,T}; stretch=stretch, eta=eta) where {I,T}
    ...
    return InteractionListsGPU(np2p, nm2l, p2p_lists, m2l_lists, p2p_lists_ptrs, m2l_lists_ptrs, np2pgroup, nm2lgroup)
end
